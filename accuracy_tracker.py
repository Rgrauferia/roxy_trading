        ...
        rows.append(
            {
                ...
                "data_bucket": alert.get("data_bucket") or alert.get("data_state"),
                "data_gate": alert.get("data_gate") or alert.get("chart_data_gate"),
        ...
        rows.append(
            {
                ...
                "data_source": signal.get("data_source") or signal.get("source"),
                "data_bucket": signal.get("data_bucket") or signal.get("data_state"),
                "data_gate": signal.get("data_gate") or signal.get("chart_data_gate"),
                "milestones": ", ".join(milestones) if milestones else "-",
