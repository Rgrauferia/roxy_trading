...
def test_roxy_home_list_pwa_shell_is_installable_and_offline_capable():
    ...
    assert 'name="roxy-home-version" content="183"' in page.text
    ...
    assert 'src="/assets/roxy_list.js?v=185"' in page.text
    ...
    assert '/assets/roxy_list.js?v=185' in worker.text
    ...
    assert 'roxy-list-shell-v182' in worker.text
    ...
    assert "const APP_VERSION = '183'" in script.text
