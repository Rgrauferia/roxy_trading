...
def test_roxy_home_list_pwa_shell_is_installable_and_offline_capable():
    ...
    assert 'href="/assets/roxy_list.css?v=86"' in page.text
    assert 'src="/assets/roxy_list.js?v=107"' in page.text
    assert '/assets/roxy_list.css?v=86' in worker.text
    assert '/assets/roxy_list.js?v=107' in worker.text
