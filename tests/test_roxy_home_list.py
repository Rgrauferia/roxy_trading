...
def test_roxy_home_list_pwa_shell_is_installable_and_offline_capable():
    ...
    assert 'name="roxy-home-version" content="136"' in page.text
    ...
    assert 'src="/assets/roxy_list.js?v=137"' in page.text
    ...
    assert '/assets/roxy_list.js?v=137' in worker.text
