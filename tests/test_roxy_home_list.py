...
def test_roxy_home_list_pwa_shell_is_installable_and_offline_capable():
    ...
    assert 'name="roxy-home-version" content="190"' in page.text
    ...
    assert 'src="/assets/roxy_list.js?v=192"' in page.text
    ...
    assert '/assets/roxy_list.js?v=192' in worker.text
    ...
    assert 'roxy-list-shell-v189' in worker.text
    for asset in ('roxy_home_drinks.js?v=2', 'roxy_home_drinks.css?v=2'):
    ...
    assert "const APP_VERSION = '190'" in script.text
