...
def test_roxy_home_list_pwa_shell_is_installable_and_offline_capable():
    ...
    assert 'name="roxy-home-version" content="167"' in page.text
    ...
    assert 'src="/assets/roxy_list.js?v=166"' in page.text
    ...
    assert '/assets/roxy_list.js?v=166' in worker.text
    ...
    assert "const APP_VERSION = '167'" in script.text
