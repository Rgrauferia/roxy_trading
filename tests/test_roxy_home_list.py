...
def test_roxy_home_list_pwa_shell_is_installable_and_offline_capable():
    ...
    assert 'name="roxy-home-version" content="170"' in page.text
    assert 'href="/assets/vendor/maplibre-gl.css?v=1"' in page.text
    assert 'src="/assets/vendor/maplibre-gl.js?v=1"' in page.text
    assert 'href="/assets/roxy_list.css?v=121"' in page.text
    assert 'src="/assets/roxy_list.js?v=169"' in page.text
    assert '/assets/vendor/maplibre-gl.css?v=1' in worker.text
    assert '/assets/vendor/maplibre-gl.js?v=1' in worker.text
    assert '/assets/roxy_list.css?v=121' in worker.text
    assert '/assets/roxy_list.js?v=169' in worker.text
    ...
    assert "const APP_VERSION = '170'" in script.text
