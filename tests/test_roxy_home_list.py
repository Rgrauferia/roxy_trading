...
def test_roxy_home_list_pwa_shell_is_installable_and_offline_capable():
    ...
    assert 'src="/assets/roxy_list.js?v=51"' in page.text
    assert '/assets/roxy_list.js?v=51' in worker.text
    ...
    assert "/v1/home-food/recipe-photo?v=2&title=" in script.text
