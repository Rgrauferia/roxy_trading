...
const cases={
 ...
 async install_core_shell_only(){
  ...
  assert.ok(downloads.every(p=>!p.includes('/roxy_fitness')),'Optional fitness modules are not extra install downloads');
  ...
  for(const pathname of ['/v1/home-food/recipe-photo?title=Exact&variant=card','/api/fitness/v1/me/profile','/api/fitness/v1/exercises','/api/fitness/v1/programs','/api/fitness/v1/programs/gentle-strength','/api/fitness/v1/me/measurements','/api/fitness/v1/me/training-logs','/api/fitness/v1/me/training-progress']){
