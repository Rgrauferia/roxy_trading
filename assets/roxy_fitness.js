...
((scope) => {
  ...
  function render() {
    ...
    if(view==='space'&&['today','week'].includes(section)&&moduleActive)scope.RoxyFitnessPrograms?.mount(root.querySelector('#fxPrograms'),{identity:context?.identity||'preview',timezone:profile.timezone,view:section});
