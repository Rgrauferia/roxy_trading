(() => {
  ...
  function renderPetProducts(pet){
    ...
    const catalogRows=(homeFood.pet_recommendations||{})[String(pet.id)]||[];const allRows=[...catalogRows].sort((left,right)=>Number(Boolean(right.identity_specific))-Number(Boolean(left.identity_specific))||Number(right.score||0)-Number(left.score||0));
