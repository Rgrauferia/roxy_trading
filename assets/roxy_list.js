(() => {
  ...
  function renderPetProducts(pet){
    ...
    const catalogRows=(homeFood.pet_recommendations||{})[String(pet.id)]||[];const specificRows=catalogRows.filter(row=>row.identity_specific);const allRows=specificRows.length?specificRows:catalogRows;
