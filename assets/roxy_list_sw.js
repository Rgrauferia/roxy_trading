const CACHE='roxy-list-shell-v10';
const SHELL=['/home','/lista-manifest.json','/assets/roxy_list.css?v=10','/assets/roxy_list_overrides.css?v=10','/assets/roxy_list.js?v=10','/assets/roxy_avatar_icon.jpg'];
