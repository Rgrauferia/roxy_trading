const CACHE='roxy-list-shell-v11';
const SHELL=['/home','/lista-manifest.json','/assets/roxy_list.css?v=11','/assets/roxy_list_overrides.css?v=11','/assets/roxy_list.js?v=11','/assets/roxy_avatar_icon.jpg'];
