const CACHE='roxy-list-shell-v7';
const SHELL=['/home','/lista-manifest.json','/assets/roxy_list.css?v=7','/assets/roxy_list_overrides.css?v=7','/assets/roxy_list.js?v=7','/assets/roxy_avatar_icon.jpg'];
