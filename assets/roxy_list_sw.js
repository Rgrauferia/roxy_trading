const CACHE='roxy-list-shell-v5';
const SHELL=['/lista','/lista-manifest.json','/assets/roxy_list.css?v=5','/assets/roxy_list_overrides.css?v=5','/assets/roxy_list.js?v=5','/assets/roxy_avatar_icon.jpg'];
