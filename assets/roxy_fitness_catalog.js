...
((scope)=>{
  ...
  const display=v=>({Arms:'Brazos',Chest:'Pecho',Legs:'Piernas',Back:'Espalda',Abs:'Abdominales',Shoulders:'Hombros',Barbell:'Barra',Dumbbell:'Mancuerna',Bench:'Banco','Incline bench':'Banco inclinado','Pull-up bar':'Barra de dominadas','SZ-Bar':'Barra EZ','Cable machine':'Máquina de poleas','none (bodyweight exercise)':'Sin material · peso corporal'}[v]||v);
